...
class BaseModel(torch.nn.Module, metaclass=MetaModel):
    ...
    def forward(self, *args, **kwargs):
        ...
        #Tora_Camera/modules/SwissArmyTransformer/sat/model/transformer.py P574
...
def get_model(args, model_cls, **kwargs):
    ...
    if check_if_zero3(args): #不做
        import deepspeed
        with deepspeed.zero.Init():
            model = model_cls(args, params_dtype=params_dtype, **kwargs)
    else:
        model = model_cls(args, params_dtype=params_dtype, **kwargs)  #SATVideoDiffusionEngine
        #/Tora_Camera/sat/diffusion_video.py P28
